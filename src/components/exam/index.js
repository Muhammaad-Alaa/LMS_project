    ...
    return (
      <>
        ...
        <Timer/>
          <form method='post' >
          <div
            className="d-flex justify-content-center align-items-center mt-sm-5 my-1"
          >
          ...
          >
            ...
            <div className="py-2 h5">
                ...
                <div className="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options">
                  <input type='text' name='answer' placeholder='solution' className="p-2 border-1 rounded-3 w-75 "/>
                </div>
            </div>
            </div>
            </div>
